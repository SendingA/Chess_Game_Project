...
//    private static final Dimension CHESSGRID_SIZE = new Dimension(1080 / 4 * 3 / 8, 1080 / 4 * 3 / 8);
    private static final Color[] BACKGROUND_COLORS = {Color.WHITE, new Color(0x2F2F31),new Color(0x915631),new Color(0xD99E75),new Color(0x51078F),new Color(0x9046CE),new Color(0x0D0DA8),new Color(0x5959C2)};
    ...
    public abstract List<ChessboardPoint> canMoveToList(ChessComponent[][] chessboard);
...
//        System.out.println("i: " + i);
        Color squareColor = BACKGROUND_COLORS[(chessboardPoint.getX() + chessboardPoint.getY()) % 2+ i ];
        g.setColor(squareColor);
        g.fillRect(0, 0, this.getWidth(), this.getHeight());
        if (isTouched()) { // Highlights the model if selected.
//            g.setColor(new Color(255, 206, 206, 185));
